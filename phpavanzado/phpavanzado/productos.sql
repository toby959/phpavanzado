...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-06-2023 a las 03:26:33
...
(123, 'auto', 'sedan', '22.99'),
(789, 'Camioneta', 'SW4', '45.00'),
(22, 'Vans', 'H1', '12.00'),
(456, 'camioneta', 'PickUp', '14.00'),
(1234, 'carro', 'tracción a sangre', '1.00');
...
--
ALTER TABLE `productos`
  MODIFY `codigo` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1235;
COMMIT;
